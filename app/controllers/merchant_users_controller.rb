class MerchantUsersController < ApplicationController
	...
	def new_merchant_user
		...
		redirect_to root_path unless Permissions::MerchantUserP.new(current_user).create?
	...
	def edit
		redirect_to root_path unless Permissions::MerchantUserP.new(current_user).edit?
  ...
  def update
	...
	def destroy_merchant_user
		redirect_to root_path unless Permissions::MerchantUserP.new(current_user).delete?
